...
<body>
    <div class="main-content">
        ...
        <div class="content-wrapper">
            <div class="container">
                <h1>Bus Route Schedule of 2A</h1>
                <div class="bus-route">
                    <div class="stop">
                    ...
                    <div class="stop">
                        ...
                        <div class="details">
                            ...
                            <p><small>Expected time of Arrival - 9:45AM</small></p>
                        </div>
                    </div>
                    <div class="stop">
                        <div class="circle"></div>
                        <div class="details">
                            ...
                            <p><small>Expected time of Arrival - 10:20AM</small></p>
                        </div>
                    </div>
                    <div class="stop">
                        <div class="circle"></div>
                        <div class="details">
                            ...
                            <p><small>Expected time of Arrival - 11:05AM</small></p>
                        </div>
                    </div>
            ...
            <div class="schedule">
                <h1>2A Bus Schedule</h1>
                <p>2A bus route operates every day. Regular schedule hours: 09:00-11:05</p>
                <table>
                    <thead>
                        <tr>
                            <th>Day</th>
